...
with open('lika.json') as fi, open('input.json', 'w') as fo:
    ...
    data_output = {
        ...
        'prompt': {
            "system_initial": "A code is often a word or short phrase that symbolically assigns a summative, salient, essence-capturing and/or evocative attribute to a portion of language-based or visual data. Perform thematic analysis on the following comment in the user message and generate a concise qualitative code. Try to be as concise as possible.",
            "system_debate": "You are a helpful coding AI. You are collaborating with other coding AIs to refine qualitative codes. You will be given a comment and the previous discussion generated by other AIs and you. Your task is to contribute to the discussion and come up with a new, refined code. You can just present your argument in plain text. Do not simulate the other models, you are responding only on behalf of yourself. Try to be as concise as possible. In the context of this debate you are [[MODEL_NAME]]. Start this argument by saying \"Thank you for your input. I think...\"",
